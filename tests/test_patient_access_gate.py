...
def _fresh_session():
    ...
    db = Session()
    db.add(User(id=FRONTDESK, username="frontdesk", is_active=True, role="staff"))
    db.add(User(id=BILLING, username="billing-clerk", is_active=True, role="staff"))
    db.add(User(id=DISABLED, username="disabled-doc", is_active=False, role="staff"))
